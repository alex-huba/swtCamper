...
public class OfferDTO {
    ...
    public String toString() {
        return "offerID: " + offerID +
                ", Fahrzeug: " + offeredObject.getVehicleFeatures().getMake() + " " + offeredObject.getVehicleFeatures().getModel() + " (" + offeredObject.getVehicleFeatures().getVehicleType() + ") (Bj. " + offeredObject.getVehicleFeatures().getYear() + ")" +
                ", Sitzplätze: " + offeredObject.getVehicleFeatures().getSeats() +
                ", Preis pro Tag: " + price +
                ", aktiv: " + active;
    }
}
