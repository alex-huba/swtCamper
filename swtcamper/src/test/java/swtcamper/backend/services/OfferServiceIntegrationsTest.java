...
public class OfferServiceIntegrationsTest {
    ...
    public Offer testOffer(User creator) throws GenericServiceException {
        ...
        return offerServiceUnderTest.create(creator,
                title,
                location,
                contact,
                particularities,
    ...
    @Test
    public void updateOfferShouldUpdateOfferToDatabase() throws GenericServiceException {
        User creator = creatorUser();
    ...
    @Test
    public void deleteOfferShouldDeleteOfferFromDatabase() throws GenericServiceException {
        User creator = creatorUser();
        assertNotNull(creator);
        UserDTO user = modelMapper.userToUserDTO(creator);
    ...
    @Test
    public void offersShouldReturnOfferListFromDatabase() throws GenericServiceException {
        User creator = creatorUser();
        testOffer(creator);
    ...
    @Test
    public void getOffersByCreatedUserShouldReturnOffersCreatedByUser() throws GenericServiceException {
        User creator = creatorUser();
        testOffer(creator);
        testOffer(creator);
        List<Offer> expectedOffers = offerServiceUnderTest.offers();

        List<Offer> resultOffers = offerServiceUnderTest.getOffersCreatedByUser(creator);

        assertEquals(expectedOffers.size(), resultOffers.size());
    }

    @Test
    public void promoteOfferShouldReturnPromotedOffer() throws GenericServiceException {
        User creator = creatorUser();
        testOffer(creator);
    ...
    @Test
    public void degradeOfferShouldReturnPromotedOffer() throws GenericServiceException {
        User creator = creatorUser();
        testOffer(creator);
        userService.setLoggedInUser(creator);
        List<Offer> offers = offerServiceUnderTest.offers();
    ...
    @Test
    public void getOfferByIdShouldReturnOfferWithSubmittedId() throws GenericServiceException {
        User creator = creatorUser();
        Offer offer = testOffer(creator);
        List<Offer> offers = offerServiceUnderTest.offers();
        long id = offers.get(0).getOfferID();

        assertEquals(offer.getOfferID(), offerServiceUnderTest.getOfferById(id).getOfferID());
    }

    @Test
    public void getOfferByIdShouldReturnGenericExceptionForInvalidId() throws GenericServiceException {
        assertThrows(GenericServiceException.class, () -> offerServiceUnderTest.getOfferById(0));
    }

    @Test
    public void getFilteredOffersShouldReturnFilteredOfferList() throws GenericServiceException {
        User creator = creatorUser();
        ...
        assertEquals(2, offerServiceUnderTest.getFilteredOffers(fridgeIsFalse).size());

    }

    @Test
    public void getBlockedDaysShouldReturnBlockedDays() throws GenericServiceException {
        User creator = creatorUser();
        Offer offer = testOffer(creator);
        ...
        assertEquals(expectedResult, offerServiceUnderTest.getBlockedDates(offer.getOfferID()));
    }

    @Test
    public void getBlockedDaysShouldReturnGenericServiceExceptionByNotFoundedOffer() {
        assertThrows(GenericServiceException.class, () -> offerServiceUnderTest.getBlockedDates(0));
    }
}
