...
public class OfferServiceIntegrationsTest {
  ...
  public void getFilteredOffersShouldReturnFilteredOfferList()
    ...
    Offer offer3 = testOffer(creator);
    ...
    System.out.println("Offer1: " + offer1.getOfferedObject().isFridge());
    offer1.getOfferedObject().setFridge(true);
    offerRepository.save(offer1);
    System.out.println("Offer1: " + offer1.getOfferedObject().isFridge());
    System.out.println("Offer2: " + offer2.getOfferedObject().isFridge());
    offer2.getOfferedObject().setFridge(true);
    offerRepository.save(offer2);
    System.out.println("Offer2: " + offer2.getOfferedObject().isFridge());
    System.out.println("Filter for Fridge: " + fridgeIsTrue.toString());

    int size = offerServiceUnderTest.getFilteredOffers(fridgeIsTrue).size();
