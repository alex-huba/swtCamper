...
public class UserServiceUnitTest {
    ...
    private User testUser = new User("ThomasK96",
            "password",
    ...
    @Test
    public void loginWithRegisteredCredentialsShouldReturnCorrectUserRole() throws UserDoesNotExistException, WrongPasswordException {
        assertThat(userServiceUnderTest.login("ThomasK96","password")).isEqualTo(UserRole.PROVIDER);
    }

    @Test
    public void loginWithWrongCredentialsShouldThrowWrongPasswordException() throws UserDoesNotExistException, WrongPasswordException {
        when(userServiceUnderTest.login("ThomasK96","passwort")).thenThrow(WrongPasswordException.class);
    }
    ...
    public void usedEmailShouldNotBeFree() {
        assertThat(userServiceUnderTest.isEmailFree("t.kretschmann@t-online.de")).isFalse();
    }

    @Test
    public void unusedEmailShouldBeFree() {
        assertThat(userServiceUnderTest.isEmailFree("paulmitp@gmail.com")).isFalse();
    }
    ...
    @Test
    public void savedUserShouldBeEnabledAfterEnabling() throws UserDoesNotExistException {
        // when
        userServiceUnderTest.create(testUser);
    ...
    @Test
    public void resetPasswordShouldApply() throws GenericServiceException, UserDoesNotExistException, WrongPasswordException {
        userServiceUnderTest.resetPassword("ThomasK96", "t.kretschmann@t-online.de", "passworT");
        assertThat(userServiceUnderTest.login("ThomasK96","passworT")).isEqualTo(UserRole.PROVIDER);
    }
}
