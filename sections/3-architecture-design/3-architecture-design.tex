...
\subsubsection{Observer Pattern (behavioral patterns)}
...
\subsubsection{Singleton Pattern (creational patterns)}
...
\subsubsection{Pipes and Filters (structural patterns)}
